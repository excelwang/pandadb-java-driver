...
import static org.neo4j.driver.internal.util.MetadataExtractor.*;
import static org.neo4j.driver.internal.util.ServerVersion.v4_0_0;
import static org.neo4j.driver.summary.QueryType.*;
...
class MetadataExtractorTest {
    ...
    void shouldExtractBookmark() {
        ...
        Bookmark bookmark = extractBookmarks(singletonMap("bookmark", value(bookmarkValue)));
    ...
    void shouldExtractNoBookmarkWhenMetadataContainsNull() {
        Bookmark bookmark = extractBookmarks(singletonMap("bookmark", null));
    ...
    void shouldExtractNoBookmarkWhenMetadataContainsNullValue() {
        Bookmark bookmark = extractBookmarks(singletonMap("bookmark", Values.NULL));
    ...
    void shouldExtractNoBookmarkWhenMetadataContainsValueOfIncorrectType() {
        Bookmark bookmark = extractBookmarks(singletonMap("bookmark", value(42)));
