...
//
//    public static final PandaResult NOOP = new PandaResult(Collections.emptyIterator());
//
//    public PandaResult(Iterator<Query.QueryResponse> responseIter, ExecutorService pool) {
//        this.responseIter = responseIter;
//        this.keys = hasNext()? prefetchedRecord.keys(): new LinkedList<String>();
//    }
//
//    public boolean isDone() {
//        return ! (responseIter.hasNext());
//    }
//
//    /**
...
//        if (! this.responseIter.hasNext()) return null;
