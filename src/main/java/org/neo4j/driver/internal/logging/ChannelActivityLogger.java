...
public class ChannelActivityLogger extends ReformattedLogger {
    ...
    private ChannelActivityLogger(Channel channel, Logger delegate) {
        ...
        this.localChannelId = channel != null ? PandaChannelAttributes.channelId(channel).toString() : null;
    }
    ...
    private String getDbConnectionId() {
        if (dbConnectionId == null) {
            dbConnectionId = PandaChannelAttributes.connectionId(channel);
        }
    ...
    private String getServerAddress() {
        ...
        if (serverAddress == null) {
            BoltServerAddress serverAddress = PandaChannelAttributes.serverAddress(channel);
