...
import static org.neo4j.driver.internal.async.connection.PandaChannelAttributes.authorizationStateListener;
...
//    private ResponseHandler autoReadManagingHandler;
    ...
    public InboundMessageDispatcher(ManagedChannel channel, Logging logging) {
...
//            channel.writeAndFlush(RESET, channel.voidPromise());//TODO send reset
//        }
