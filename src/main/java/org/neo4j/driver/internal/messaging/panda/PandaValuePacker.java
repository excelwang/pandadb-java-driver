...
public class PandaValuePacker implements ValuePacker {
    ...
    public PandaValuePacker(PackOutput output, boolean dateTimeUtcEnabled) {
    ...
    private void packPoint(Point point) throws IOException {
        if (point instanceof InternalPoint2D) {
            ...
            throw new IOException(
                    String.format("Unknown type: type: %s, value: %s", point.getClass(), point));
        }
    }
