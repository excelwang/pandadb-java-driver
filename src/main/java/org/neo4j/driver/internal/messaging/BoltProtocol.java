...
public interface BoltProtocol {
     ...
     * @throws ClientException when unable to find protocol version for the given channel.
     */
    static BoltProtocol forChannel(ManagedChannel channel) {
        return forVersion(PandaChannelAttributes.protocolVersion(channel));
    }
     ...
     */
    static BoltProtocol forVersion(BoltProtocolVersion version) {//todo move to pandaProtocol
        ...
        } else if (PandaProtocol.VERSION.equals(version)) {
            return PandaProtocol.INSTANCE;
        }
